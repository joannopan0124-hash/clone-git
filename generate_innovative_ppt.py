...
def add_kids_intro_slide():
    ...
    for i, (title, desc, icon) in enumerate(features):
        ...
        # 柔和背景卡片
        card = add_subtle_card(slide, x, y, col_width, Inches(4.5), WHITE)
        
        # 图标 - 放在卡片顶部中央
        icon_box = slide.shapes.add_textbox(x, y + Inches(0.3), col_width, Inches(1))
        ...
        # 标题 - 放在图标下方
        title_box = slide.shapes.add_textbox(x, y + Inches(1.5), col_width, Inches(0.7))
        tf = title_box.text_frame
        ...
        # 描述 - 放在标题下方，留出足够间距
        desc_box = slide.shapes.add_textbox(x + Inches(0.1), y + Inches(2.4), col_width - Inches(0.2), Inches(2))
    ...
    bottom_decor = slide.shapes.add_textbox(Inches(2), Inches(6.3), Inches(9.3), Inches(0.8))
...
def add_kids_scenarios_slide():
    ...
    for i, ((title, desc, tag), (x, y)) in enumerate(zip(scenarios, positions)):
        ...
        t_box = slide.shapes.add_textbox(x+Inches(0.3), y+Inches(0.2), Inches(7.3), Inches(0.6))
        tf = t_box.text_frame
        tf.paragraphs[0].text = title
        tf.paragraphs[0].font.size = Pt(24)
        tf.paragraphs[0].font.bold = True
        ...
        d_box = slide.shapes.add_textbox(x+Inches(0.5), y+Inches(0.8), Inches(6.9), Inches(0.8))
        tf = d_box.text_frame
        tf.paragraphs[0].text = desc
        tf.paragraphs[0].font.size = Pt(18)
        tf.paragraphs[0].font.color.rgb = GRAY
...
def add_kids_workflow_slide():
    ...
    for i, (title, desc) in enumerate(steps):
        ...
        d_box = slide.shapes.add_textbox(x, y+Inches(1.9), Inches(3.4), Inches(1.5))
        tf = d_box.text_frame
        tf.paragraphs[0].text = desc
        tf.paragraphs[0].font.size = Pt(16)
        tf.paragraphs[0].font.color.rgb = DARK_GRAY
...
def add_interpreter_intro_slide():
    ...
    for i, (title, desc, icon) in enumerate(features):
        ...
        # 标题
        title_box = slide.shapes.add_textbox(x, y+Inches(1.4), Inches(3.5), Inches(0.6))
        tf = title_box.text_frame
        tf.paragraphs[0].text = title
        ...
        # 描述
        desc_box = slide.shapes.add_textbox(x+Inches(0.1), y+Inches(2.2), Inches(3.3), Inches(1.5))
        tf = desc_box.text_frame
        tf.paragraphs[0].text = desc
        tf.paragraphs[0].font.size = Pt(16)
        tf.paragraphs[0].font.color.rgb = DARK_GRAY
...
def add_interpreter_scenarios_slide():
    ...
    for i, (title, desc) in enumerate(scenarios):
        ...
        t_box = slide.shapes.add_textbox(Inches(2.7), y_positions[i]+Inches(0.2), Inches(7.9), Inches(0.6))
        tf = t_box.text_frame
        tf.paragraphs[0].text = title
        tf.paragraphs[0].font.size = Pt(22)
        tf.paragraphs[0].font.bold = True
        ...
        d_box = slide.shapes.add_textbox(Inches(3), y_positions[i]+Inches(0.8), Inches(7.3), Inches(0.6))
        tf = d_box.text_frame
        tf.paragraphs[0].text = desc
...
def add_interpreter_workflow_slide():
    ...
    for i, (title, desc) in enumerate(steps):
        ...
        num_box = slide.shapes.add_textbox(x+Inches(0.3), y+Inches(0.15), Inches(1), Inches(0.6))
        ...
        t_box = slide.shapes.add_textbox(x+Inches(1.2), y+Inches(0.25), Inches(3.5), Inches(0.6))
        tf = t_box.text_frame
        tf.paragraphs[0].text = title
        tf.paragraphs[0].font.size = Pt(20)
        tf.paragraphs[0].font.bold = True
        ...
        d_box = slide.shapes.add_textbox(x+Inches(1.2), y+Inches(1), Inches(3.5), Inches(0.9))
        tf = d_box.text_frame
        tf.paragraphs[0].text = desc
        tf.paragraphs[0].font.size = Pt(16)
        tf.paragraphs[0].font.color.rgb = GRAY
...
def add_comparison_slide():
    ...
    left_title = slide.shapes.add_textbox(Inches(1), Inches(1.6), Inches(4.8), Inches(0.7))
    tf = left_title.text_frame
    ...
    left_desc = slide.shapes.add_textbox(Inches(1.2), Inches(2.4), Inches(4.4), Inches(2.2))
    tf = left_desc.text_frame
    ...
    right_title = slide.shapes.add_textbox(Inches(7.5), Inches(1.6), Inches(4.8), Inches(0.7))
    tf = right_title.text_frame
    ...
    right_desc = slide.shapes.add_textbox(Inches(7.7), Inches(2.4), Inches(4.4), Inches(2.2))
    tf = right_desc.text_frame
...
def add_summary_slide():
    ...
    for i, (title, desc, color) in enumerate(points):
        ...
        t_box = slide.shapes.add_textbox(Inches(2.7), y+Inches(0.15), Inches(7.9), Inches(0.6))
        tf = t_box.text_frame
        tf.paragraphs[0].text = title
        tf.paragraphs[0].font.size = Pt(24)
        tf.paragraphs[0].font.bold = True
        ...
        d_box = slide.shapes.add_textbox(Inches(3), y+Inches(0.75), Inches(7.3), Inches(0.6))
        tf = d_box.text_frame
        tf.paragraphs[0].text = desc
        tf.paragraphs[0].font.size = Pt(18)
        tf.paragraphs[0].font.color.rgb = GRAY
